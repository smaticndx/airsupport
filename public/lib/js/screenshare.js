...
function CheckChromeFrame() {
  loadScript(
    "http://google.com/tools/dlpage/res/chromeframe/script/CFInstall.min.js",
    function() {
      CFInstall.check({
        mode: "popup"
      });
...
function init() {
  yepnope({
    load: [CDN + "lib/js/session.js", CDN + "lib/css/screenshare.css"],
    complete: function() {
      if (sessvars.Session) {
        ContinueSession();
      }
